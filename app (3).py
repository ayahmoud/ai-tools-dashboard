...
# Load your original full CSV
df = pd.read_csv("sample_data/Ai_Tools_Data.csv")

# Create a smaller sample of the first 100 rows
df_sample = df.head(100)

# Save it in the current directory (not inside /sample_data/)
df_sample.to_csv("Ai_Tools_Data_Sample.csv", index=False)
